...
export default class Agente{
    ...
    setChofer(chofer:chofer){
        this.setAgente({id:chofer.id, nombre:chofer.nombre, codigo:chofer.codigo})
    ...
    setAuto(auto:auto){
        this.setAgente({id:auto.id,nombre:auto.nombre, codigo:auto.codigo})
        this.idCliente = 1
        ...
        this.segmento3 = auto.configuracon
    }

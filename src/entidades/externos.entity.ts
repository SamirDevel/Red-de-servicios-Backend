...
export default class Externo{
    ...
    @Column({name:'CIDVALORCLASIFCLIENTE1'})
    clasificacionCliente1:number
    
    @Column({name:'CIDVALORCLASIFCLIENTE2'})
    clasificacionCliente2:number
    
    @Column({name:'CIDVALORCLASIFCLIENTE3'})
    clasificacionCliente3:number
    
    @Column({name:'CIDVALORCLASIFCLIENTE4'})
    clasificacionCliente4:number
